  ...
  return (
    ...
    boxShadow={
      ...
      <Text fontWeight={"semibold"} fontSize="40px">
        ...
        />
        <Button w={'80px'} bg="orange" color="white" height="45px" onClick={addTodo}> Add Todo </Button>
            ...
            return (
              ...
              >
                ...
                {element.todo}
                  ...
                  <Button ml="50px" bg='orange' color='white' borderColor={"black"} onClick={()=>{deleteTodo(element)}}>Delete</Button>
